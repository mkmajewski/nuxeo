...
public class RecomputeVideoInfoComputation extends AbstractBulkComputation {
    ...
    public static final String ONLY_RECOMPUTE_MISSING_VIDEO_INFO = "onlyRecomputeMissingVideoInfo";

    protected Boolean onlyMissing;
    ...
    public void startBucket(String bucketKey) {
        ...
        onlyMissing = command.getParam(ONLY_RECOMPUTE_MISSING_VIDEO_INFO);
    }
    ...
    protected void compute(CoreSession session, List<String> ids, Map<String, Serializable> properties) {
        ...
        for (String docId : ids) {
            ...
            if (videoInfo.getDuration() != 0 && onlyMissing) {
                continue;
            }
            ...
            try {
                ...
                log.debug(String.format("Updating video info of document %s.", workingDocument));
                try {
                ...
                log.debug(String.format("End updating video info of document %s.", workingDocument));
